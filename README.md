# Add contacts to your laravel package. Provides simple generic contact models and allows for address (with GooglePlace API support), phone numbers and email addresses
